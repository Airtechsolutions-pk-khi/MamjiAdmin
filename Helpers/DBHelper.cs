...
namespace WebAPICode.Helpers
{
    ...
    {
        private static readonly string connectionString = "data source=95.217.141.238;initial catalog=mamjihos_db;persist security info=True;user id=mamjihos;password=Tech@123;";
