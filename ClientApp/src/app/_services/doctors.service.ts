...
interface SearchDoctorsResult {
  ...
  export class DoctorsService {
    ...
    get data$() {
      ...
      getById(id,doctorID) {
        return this.http.get<Doctors[]>('api/doctor/${id}/brand/${doctorID}');
      }
      getAllData(DoctorID) {
      ...
      update(updateData) {
        return this.http.post(`api/doctor/update`, updateData)
          .pipe(map(res => {
            console.log(res);
            return res;
          }));
      ...
      delete(updateData) {
        return this.http.post(`api/doctor/delete`, updateData);
      }
    }
